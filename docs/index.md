...
![vue 3.x](https://img.shields.io/badge/vue-3.x-green.svg)
...
<img src="https://github.com/ncform/ncform/raw/master/docs/images/ncform-banner.gif" alt="preview" style="max-width:100%;box-shadow:0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19) !important">
