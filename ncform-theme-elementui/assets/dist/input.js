...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] src/components/control-comps/input.vue: named exports in *.vue files are ignored.")}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./input.vue", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./input.vue");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var controlMixin = _ncformCommon2.default.mixins.vue.controlMixin; // <template>
	...
	exports.default = {
	  ...
	  created: function created() {
	    ...
	    if (this.$data.modelVal !== undefined) {
	      this.$data.inputVal = ["string", "number"].indexOf((0, _typeof3.default)(this.$data.modelVal)) >= 0 ? this.$data.modelVal : this.$data.modelVal[this.$data.mergeConfig.modelField];
	    }

	    if ((0, _get3.default)(this.$data.mergeConfig, "autocomplete.itemTemplate")) {
	      this.$data.itemTemplate.template = (0, _get3.default)(this.$data.mergeConfig, "autocomplete.itemTemplate");
	    }

	    if ((0, _get3.default)(this.$data.mergeConfig, "compound.prependSelect")) {
	      if ((0, _get3.default)(this.$data.mergeConfig, "compound.prependSelect.enumSource")) {
	        this.$data.prependSelectOptions = (0, _get3.default)(this.$data.mergeConfig, "compound.prependSelect.enumSource");
	      } else {
	        (0, _axios2.default)({
	          url: (0, _get3.default)(this.$data.mergeConfig, "compound.prependSelect.enumSourceRemote.remoteUrl")
	        }).then(function (res) {
	          _this.$data.prependSelectOptions = _this.$data.mergeConfig.compound.prependSelect.enumSourceRemote.resField ? (0, _get3.default)(res.data, _this.$data.mergeConfig.compound.prependSelect.enumSourceRemote.resField) : res.data;
	        });
	      }
	      this.$data.prependSelectVal = (0, _get3.default)(this.value, (0, _get3.default)(this.$data.mergeConfig, "compound.prependSelect.modelField"));
	    ...
	    if ((0, _get3.default)(this.$data.mergeConfig, "compound.appendSelect")) {
	      if ((0, _get3.default)(this.$data.mergeConfig, "compound.appendSelect.enumSource")) {
	        this.$data.appendSelectOptions = (0, _get3.default)(this.$data.mergeConfig, "compound.appendSelect.enumSource");
	      } else {
	        (0, _axios2.default)({
	          url: (0, _get3.default)(this.$data.mergeConfig, "compound.appendSelect.enumSourceRemote.remoteUrl")
	        }).then(function (res) {
	          _this.$data.appendSelectOptions = _this.$data.mergeConfig.compound.appendSelect.enumSourceRemote.resField ? (0, _get3.default)(res.data, _this.$data.mergeConfig.compound.appendSelect.enumSourceRemote.resField) : res.data;
	        });
	      }
	      this.$data.appendSelectVal = (0, _get3.default)(this.value, (0, _get3.default)(this.$data.mergeConfig, "compound.appendSelect.modelField"));
	  ...
	  methods: {
	    querySearch: function querySearch(queryString, cb) {
	      var autoCpl = this.$data.mergeConfig.autocomplete;
	    ...
	    handleFileChange: function handleFileChange() {
	      ...
	      var sendObj = (0, _assign2.default)({}, data);
	      ...
	      if (vm.mergeConfig.upload.constraint.maxSize && fileSize > vm.mergeConfig.upload.constraint.maxSize) {
	        vm.$message({
	          message: "\u8BF7\u4E0A\u4F20\u5C0F\u4E8E" + vm.mergeConfig.upload.constraint.maxSize + "KB\u7684\u6587\u4EF6\uFF0C\u60A8\u7684\u6587\u4EF6\u4E3A" + fileSize.toFixed(0) + "KB",
	          type: "error"
	        });
	        return;
	      }
	      if (vm.mergeConfig.upload.constraint.minSize && fileSize < vm.mergeConfig.upload.constraint.minSize) {
	        vm.$message({
	          message: "\u8BF7\u4E0A\u4F20\u5927\u4E8E" + vm.mergeConfig.upload.constraint.minSize + "KB\u7684\u6587\u4EF6\uFF0C\u60A8\u7684\u6587\u4EF6\u4E3A" + fileSize.toFixed(0) + "KB",
	          type: "error"
	        });
	        return;
	      }
	      ...
	      // 图片类型判断是否符合宽高要求
	      var jurgeImgPromise = new _promise2.default(function (resolve) {
	          ...
	          reader.onload = function (theFile) {
	            ...
	            image.onload = function () {
	              ...
	              if (vm.mergeConfig.upload.constraint.sizeFixed) {
	                ...
	                pass = (this.width / this.height).toFixed(0) === (vm.mergeConfig.upload.constraint.width / vm.mergeConfig.upload.constraint.height).toFixed(0);
	              }
	              if (!pass) {
	                if (vm.mergeConfig.upload.constraint.sizeFixed) {
	                  vm.$message({
	                    message: "\u8BF7\u4E0A\u4F20" + vm.mergeConfig.upload.constraint.width + "x" + vm.mergeConfig.upload.constraint.height + "\u7684\u56FE\u7247\uFF0C\u4F60\u7684\u56FE\u7247\u4E3A" + this.width + "x" + this.height,
	                    type: "error"
	                  });
	                } else {
	                  vm.$message({
	                    message: "\u8BF7\u4E0A\u4F20\u5BBD\u9AD8\u6BD4\u4E3A" + vm._getFractionalExpression(vm.mergeConfig.upload.constraint.width / vm.mergeConfig.upload.constraint.height, 0.01) + "\u7684\u56FE\u7247\uFF0C\u4F60\u7684\u56FE\u7247\u5BBD\u9AD8\u6BD4\u4E3A" + vm._getFractionalExpression(this.width / this.height, 0.01),
	                    type: "error"
	                  });
	                }
	              } else {
	      ...
	      jurgeImgPromise.then(function () {
	        ...
	        try {
	          for (var _iterator = (0, _getIterator3.default)((0, _entries2.default)(sendObj)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var promiseResolve = __webpack_require__(279);
	var PROMISE = 'Promise';
